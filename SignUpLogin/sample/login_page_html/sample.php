...
<body>
        <div class="container" id="cont">
                ...
                <a href="#home">&lbbrk;&Lscr;&Hopf;&rbbrk;</a>
                  <a href="#news">News</a>
                  <a href=#signup/login onclick="document.getElementById('id01').style.display='block'" style="inline-size:auto;">&#10098;SignUp/Login&#10099;</a>
...
<!----------------------------LOGIN POPUP ----------------------------------------------------------->
                ...
                <div id="id01" class="modal">
                        ...
                        <form class="modal-content animate" action="http://localhost:8080/sample/signup.php" method="POST">
                          ...
                          <div class="container1" style="text-align: center;">
                            ...
                            <tr><td><label for="cname" style="padding-inline-end: 10px;"><b>User name:</b></label></td><td><input type="text" placeholder="Enter Company name" name="cname" id="name" required style="text-align: center;"></td></tr>
                          ...
                          <center><button type="submit" style="color: darkcyan; font-size: 17px;" onmousemove="validate1();"  >submit</button> or 
                                <a href="#login" onclick="popup1();" style="inline-size:auto; text-decoration: none;">Login</a></center>
    ...
    <div id="id02" class="modal">
        ...
        <form class="modal-content animate" action="http://localhost/sample/login.php" method="POST">
          ...
          <center><button type="submit" style="color: darkcyan; font-size: 17px;" onmouseover="evalidate();"  >Login</button> or 
                <a href="#signup" onclick="popup2();" style="inline-size:auto; text-decoration: none;">Sign up</a></center>
          ...
          <div class="container1" style="background-color:#f1f1f1">
            ...
            <span class="psw">Forgot <a href="#" style="inline-size:auto; text-decoration: none;">password?</a></span>
          </div>
        </form>
</div>
<!----------------------------END------------------------------------------------------->                             
