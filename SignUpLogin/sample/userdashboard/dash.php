...
<body>
  ...
  <!-----------------------customer profile table------------------------------>           
              <tr><td><label for="cname" style="padding-inline-end: 10px;"><b>user name:</b></label></td><td><p placeholder="Enter Company name" name="  " id="name"  style="text-align: center; font-size: 20px;"><?php echo($cname);?></p></td></tr>
